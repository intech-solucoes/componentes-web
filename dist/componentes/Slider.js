...
var Slider = /** @class */ (function (_super) {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.props.contexto.setState((_a = {},
                                _a[this.props.nome] = parseFloat(value),
                                _a))];
                    case 1:
                        // usa o setState do pai (settado no contexto) para atualizar o valor
                        _b.sent();
                        if (!this.props.onChange) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.props.onChange(value)];
                    case 2:
                        _b.sent();
                        _b.label = 3;
    ...
    Slider.prototype.render = function () {
        return (React.createElement(Styles, { cor: this.props.cor },
            React.createElement("input", { type: "range", id: this.props.nome, name: this.props.nome, min: this.props.min, max: this.props.max, step: this.props.step, value: this.props.valor, className: "slider", onChange: this.onChange }),
