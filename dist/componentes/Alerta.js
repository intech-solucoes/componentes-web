...
var Alerta = /** @class */ (function (_super) {
    ...
    Alerta.prototype.render = function () {
        var classes = classNames("alert", ["alert-" + this.props.tipo], this.props.className);
        return (React.createElement("div", null, (this.state.mensagem || this.props.mensagem) &&
            React.createElement("div", { id: "alerta", className: classes, dangerouslySetInnerHTML: { __html: this.props.mensagem + this.state.mensagem } })));
    };
    Alerta.defaultProps = {
        mensagem: "",
        tamanho: "12",
